...
export function Gcdl2(props) {

  const { nodes, materials, animations } = useGLTF('./models/gazebo/gcdl2.gltf')
  const { gcdTwoTexture, gazeboCeilingDrapeTwo } = useConfigurator();
  const group = useRef()
    ...
    <group ref={group} {...props} dispose={null}>
      {gazeboCeilingDrapeTwo === true && (
        <>
          ...
          <group name="Scene">
            <mesh name="gcdl2" geometry={nodes.gcdl2.geometry} material={materials['Material-_4Material850.006']} position={[-11.28, 2.36, -10.16]} scale={0.13} >
...
useGLTF.preload('./models/gazebo/gcdl2.gltf')
